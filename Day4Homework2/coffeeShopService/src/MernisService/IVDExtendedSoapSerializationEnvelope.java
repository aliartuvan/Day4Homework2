...
public class IVDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IVDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IVDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IVDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IVDDateTimeConverter dateTimeConverter = new IVDStandardDateTimeConverter();

    public IVDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IVDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IVDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IVDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IVDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IVDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
