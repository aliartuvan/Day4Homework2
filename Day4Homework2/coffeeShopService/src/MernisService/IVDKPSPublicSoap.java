...
public class IVDKPSPublicSoap
{
    ...
    public IVDKPSPublicSoap(){}

    public IVDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IVDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IVDExtendedSoapSerializationEnvelope envelope= new IVDExtendedSoapSerializationEnvelope(IVDExtendedSoapSerializationEnvelope.VER11);
